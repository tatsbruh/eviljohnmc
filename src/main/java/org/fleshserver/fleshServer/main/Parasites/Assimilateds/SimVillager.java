...
public class SimVillager extends ZombieVillager {
    public SimVillager(EntityType<? extends ZombieVillager> entitytypes, Level world) {
        super(entitytypes, world);
        this.getBukkitEntity().setCustomName(GenericUtils.format("&6Infected Villager"));
        EntityHelper.setMobHealth((LivingEntity) this.getBukkitEntity(),16);
        EntityHelper.setMobDamage((LivingEntity) this.getBukkitEntity(),10);
        ...
        DataHandler.set(this.getBukkitEntity(),"simvillager", PersistentDataType.STRING,"simvillager");
