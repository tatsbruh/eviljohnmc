...
public class SimEnderman extends EnderMan {
    public SimEnderman(EntityType<? extends EnderMan> entitytypes, Level world) {
        super(entitytypes, world);
        this.getBukkitEntity().setCustomName(GenericUtils.format("&6Infected Enderman"));
        EntityHelper.setMobHealth((org.bukkit.entity.LivingEntity) this.getBukkitEntity(),55);
        EntityHelper.setMobDamage((org.bukkit.entity.LivingEntity) this.getBukkitEntity(),11);
        ...
        DataHandler.set(this.getBukkitEntity(),"simenderman", PersistentDataType.STRING,"simenderman");
        DataHandler.set(this.getBukkitEntity(),"assimilated", PersistentDataType.STRING,"assimilated");
        EntityHelper.addPotionEffect((org.bukkit.entity.LivingEntity) this.getBukkitEntity(), PotionEffectType.SPEED,2);
