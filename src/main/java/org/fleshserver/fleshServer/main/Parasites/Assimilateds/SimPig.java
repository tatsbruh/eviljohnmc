...
public class SimPig extends Pig {
    private static Field attributeMap;
    public SimPig(EntityType<? extends Pig> entitytypes, Level world) {
        ...
        this.getBukkitEntity().setCustomName(GenericUtils.format("&6Infected Pig"));
        EntityHelper.setMobHealth((LivingEntity) this.getBukkitEntity(),9);
        EntityHelper.setMobDamage((LivingEntity) this.getBukkitEntity(),4);
        ...
        DataHandler.set(this.getBukkitEntity(),"simpig", PersistentDataType.STRING,"simpig");
