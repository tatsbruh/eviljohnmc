...
public class SimCow extends Cow {
    private static Field attributeMap;
    public SimCow(EntityType<? extends Cow> entitytypes, Level world) {
        ...
        this.getBukkitEntity().setCustomName(GenericUtils.format("&6Infected Cow"));
        EntityHelper.setMobHealth((LivingEntity) this.getBukkitEntity(),18);
        ...
        DataHandler.set(this.getBukkitEntity(),"simcow", PersistentDataType.STRING,"simcow");
